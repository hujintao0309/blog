---
title: markdown功能介绍与使用说明（1）
date: 2018-02-08 16:32:38
categories: "markdown学习之路"
tags:
     - markdown
---
markdown通过标记符号，巧妙地解决了使用word的排版纠结。markdowm让我们更好地专注于内容。
我们只需要通过敲键盘，不需要使用鼠标，就可以很轻易地写出排版简洁、图文并茂的文章以及绘制各种图表
利用markdown可以做什么？给大家细细道来
## 概述
### 宗旨
